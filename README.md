...
* I will be solving these problems on here with Java first. 
* I encourage the community to solve problems in other languages
* Please keep to the directory paths used. 
* Please use CAC methods in your code (**Crazy Amounts of Comments**)
